...
class ServerThread extends Thread {
    ...
    private synchronized void getOrders(Message sent) throws IOException {
        String username = sent.getObject().toString();
        ous.writeObject(new Message("Orders:", server.getUserOrders(username)));
    }
    ...
    private void checkout(Message sent) throws IOException {
        User user = (User) sent.getObject();
