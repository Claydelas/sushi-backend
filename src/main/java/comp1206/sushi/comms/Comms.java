...
public class Comms implements Runnable {
     ...
     */
    public Comms(ArrayList<User> users, ArrayList<Postcode> postcodes, HashMap<String, User> availableUsers, ArrayList<Dish> dishes, ArrayList<Order> orders, Inventory inventory, HashMap<String, Integer> ordersId) {
        try {
    ...
    /**
     * Send message for the Comms class
     */
    ...
    /**
     * Receive message from the Comms class
     */
    ...
    public void run() {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("Comms waiting for connection requests...");
    ...
    class ServerClientThread extends Thread {
        ...
        private void checkout(Message sent, ObjectOutputStream ous) throws IOException {
            ...
            if (hasEnough) {
                ...
                Order orderOfUser = new Order(getUser, getUser.getBasket(), id);
